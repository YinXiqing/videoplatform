...
export default function Upload() {
	...
	const handleVideo = (e: React.ChangeEvent<HTMLInputElement>) => {
		...
		if (f.size > 500 * 1024 * 1024)
			return setError("视频文件大小不能超过500MB");
		setVideoFile(f);
		setError("");
	};
			...
			<div className="min-h-screen bg-gray-50 dark:bg-[#0f0f0f] py-6">
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<form
						...
						className="bg-white dark:bg-[#1f1f1f] rounded-xl shadow-sm p-6"
					>
									...
									{!videoFile ? (
										...
										>
											...
											<p className="text-sm text-gray-400 dark:text-gray-500">
												支持 MP4, AVI, MKV, MOV, WMV，最大 500MB
											</p>
										</div>
									) : (
								...
								<div>
									...
									{!coverFile ? (
										<div
											...
											className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center cursor-pointer hover:border-primary-500 hover:bg-primary-50 transition-colors"
										>
							...
							<div className="space-y-4">
								{(
									...
									<div key={f.name}>
										...
										<input
											...
											required={f.required}
											className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-[#2a2a2a] dark:text-gray-100 dark:focus:ring-primary-400 dark:bg-[#2a2a2a] dark:text-gray-100 dark:placeholder-gray-500"
								...
								<div>
									...
									<textarea
										...
										className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-[#2a2a2a] dark:text-gray-100 dark:focus:ring-primary-400 resize-none"
