				...
				<form onSubmit={handleSubmit} className="space-y-5">
					...
					<div>
						...
						<input
							...
							className="w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-[#2a2a2a] dark:text-gray-100 dark:focus:ring-primary-400 dark:bg-[#2a2a2a] dark:text-gray-100 dark:placeholder-gray-500"
