...
export default function LikedPage() {
	...
	const fetchLiked = useCallback(async (p = 1) => {
		setLoading(true);
		try {
			const res = await api.get("/video/liked", { params: { page: p, per_page: 20 } });
	...
	useEffect(() => { fetchLiked(page); }, [page, fetchLiked]);

	return (
		<RequireAuth>
			<div className="min-h-screen bg-gray-50 dark:bg-[#0f0f0f] py-8">
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
					<h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">赞过的视频</h1>
