						...
						<div className="relative">
							<div className="flex gap-2 overflow-x-auto scrollbar-none pb-1">
								<button
									...
									className={`px-3 py-1 rounded-full text-sm whitespace-nowrap shrink-0 transition-colors ${activeTag === "" ? "bg-primary-600 text-white" : "bg-gray-100 dark:bg-[#2a2a2a] text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600"}`}
								>
									全部
								</button>
								{allTags.slice(0, 20).map((tag) => (
									<button
										...
										className={`px-3 py-1 rounded-full text-sm whitespace-nowrap shrink-0 transition-colors ${activeTag === tag ? "bg-primary-600 text-white" : "bg-gray-100 dark:bg-[#2a2a2a] text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600"}`}
									>
										{tag}
									</button>
								))}
