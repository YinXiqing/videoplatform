...
export default function NotificationBell() {
	...
	return (
		<div className="relative group">
			...
			<div className="absolute right-0 top-8 w-64 bg-white dark:bg-[#2a2a2a] rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 py-1 text-sm invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-150 z-50">
				...
				{count > 0 && (
					<Link
						href={isAdmin() ? "/admin/videos" : "/my-videos"}
				...
				{count === 0 && (
					<p className="px-4 py-2 text-gray-400 dark:text-gray-500">暂无通知</p>
				)}
			</div>
		</div>
	);
