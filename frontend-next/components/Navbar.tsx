				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="relative flex items-center h-14">
						...
						>
							...
							<span className="hidden sm:block text-base font-bold text-gray-900 dark:text-gray-100">
								视频平台
							</span>
						</Link>
						...
						<form
							...
							className="hidden md:block absolute left-1/2 -translate-x-1/2 w-full max-w-lg px-4"
						>
							<div className="relative">
								...
								<button
									type="submit"
									className="absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-primary-600 transition-colors"
								>
									<svg
						...
						<div className="flex items-center gap-2 ml-auto z-10">
							...
							{user ? (
										...
										{showUserMenu && (
											<div className="absolute right-0 top-10 w-44 bg-white dark:bg-[#2a2a2a] rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 py-1 text-sm z-50 opacity-0 translate-y-[-8px] [animation:menuFadeIn_0.15s_ease-out_forwards]">
												...
												<button
													...
													className="w-full text-left px-4 py-2 text-red-500 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border-t border-gray-100 dark:border-gray-700 mt-1"
												>
													退出登录
												</button>
											</div>
								...
								<>
									<Link
										href="/login"
										className="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 px-2"
									>
										登录
									</Link>
									<Link
